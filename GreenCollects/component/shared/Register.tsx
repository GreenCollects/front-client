    ...
    return (
        <>
            ...
            <Input
                ...
                onChangeText={(nextValue) =>
                    handleFirstNameFieldChange(nextValue)
                }
            ...
            <Input
                ...
                onChangeText={(nextValue) =>
                    handleLastNameFieldChange(nextValue)
                }
            ...
            <Input
                ...
                onChangeText={(nextValue) =>
                    handleRepeatPasswordFieldChange(nextValue)
                }
            ...
            <Button disabled={!formValidated} onPress={() => handleRegister()}>
                Register
            </Button>
        </>
    );
