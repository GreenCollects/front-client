  ...
  const createCollectOnPress = () => {
    ...
    if (
      ...
      const getData = async () => {
        ...
        const data: any = await createCollect(headers, JSON.stringify(body));
      ...
      <View style={styles.container}>
        ...
        <View>
          <View style={styles.formDate}>
            <Text style={styles.wasteLabel}>Date de la récolte</Text>
            <Datepicker
          ...
          <View style={styles.formWaste}>
            <Text style={styles.wasteLabel}>Les déchets à récolter</Text>
            <Select
              multiSelect={true}
          ...
          <View style={styles.formVolume}>
            <Text style={styles.volumeLabel}>Volume de la récolte (Kg)</Text>
            <Input
              placeholder="20"
          ...
          <View style={styles.formLocation}>
            <Text style={styles.positionLabel}>Où la récolte se situera ?</Text>
            <View style={styles.formLocation}>
              <View>
